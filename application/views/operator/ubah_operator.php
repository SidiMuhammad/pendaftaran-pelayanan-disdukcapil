<div class="app-container">
    <div class="card">
        ...
        <div class="card-body">
            <form id="form_tambah_operator" method="POST" action="<?= base_url('operator/ubah_operator/validation'); ?>">
                ...
                <div class="form-grid-daftar">
                    <div>
                        ...
                        <div class="input-group">
                            <input id="name" name="name" type="text" class="form-input" placeholder="Nama Operator" value="<?= $operator['nama_operator']; ?>">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            <input id="password" name="password" type="password" class="form-input input-icon" placeholder="Kata Sandi Baru">
                    ...
                    <div>
                        ...
                        <div class="radio-input-container">
                            <input id="operator_pengecekan" name="role" type="radio" value="Operator Pengecekan" <?php if ($operator['peran_operator'] == 'Operator Pengecekan') echo 'checked'; ?>>
                            ...
                            <input id="operator_pelayanan" name="role" type="radio" value="Operator Pelayanan" <?php if ($operator['peran_operator'] == 'Operator Pelayanan') echo 'checked'; ?>>
                            ...
                            <input id="operator_pemrosesan" name="role" type="radio" value="Operator Pemrosesan" <?php if ($operator['peran_operator'] == 'Operator Pemrosesan') echo 'checked'; ?>>
                            ...
                            <input id="admin" name="role" type="radio" value="Administrator" <?php if ($operator['peran_operator'] == 'Administrator') echo 'checked'; ?>>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            <input id="meja" name="meja" type="text" class="form-input" placeholder="Nomor Meja Pelayanan" value="<?= $operator['meja_operator']; ?>">
                        </div>
                        <div id="meja_error" class="form-warning"></div>
                    </div>
                </div>
                <div class="btn-container">
                    <button type="submit" class="btn-green">UBAH OPERATOR</button>
                </div>
            </form>
        </div>
    </div>
