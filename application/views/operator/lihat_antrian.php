                                        ...
                                        <div class="card dropdown-menu table-opt">
                                            <ul>
                                                <li>
                                                    ...
                                                    <?php if ($value_1['status_antrian'] == 'daftar success'  && $role == 'Operator Pengecekan') : ?>
                                                        <a href="<?= base_url('operator/cek_syarat/?id_antrian=' . $value_1['id_antrian']); ?>">Cek Syarat</a>
                                                    <?php elseif ($value_1['status_antrian'] == 'cek success'   && $role == 'Operator Pelayanan') : ?>
                                                        <a href="<?= base_url('operator/cek_sinkron/?id_antrian=' . $value_1['id_antrian']); ?>">Mulai Pelayanan</a>
                                                    <?php endif ?>
                                                </li>
                                            </ul>
                                        </div>
